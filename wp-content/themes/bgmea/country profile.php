...
<!--                <p class="n_president_statement_link">Apparel Story</p>-->
         ...
         <div class="n_dailyBox n_president_box_wrap">
            <a href="<?php echo get_home_url(); ?>/activities/we-belong-we-care/"><img class="n_media_section_president_img n_media_section_our_team_img" src="<?php echo get_home_url(); ?>/wp-content/uploads/2019/12/we-care-min.jpg" alt="image not found">
                <p class="n_president_statement_link">We belong, we care</p></a>
         </div>
      </div>
