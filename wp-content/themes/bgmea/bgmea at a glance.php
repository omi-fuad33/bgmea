<?php
   /*
       Template Name: BGMEA at a glance
    */
   ?>
<?php
   get_header();
...
<!--                <p class="n_president_statement_link">Apparel Story</p>-->
         ...
         <div class="n_dailyBox n_president_box_wrap">
            <a href="<?php echo get_home_url(); ?>/tech-innovation/"><img class="n_media_section_president_img n_media_section_our_team_img" src="<?php echo get_home_url(); ?>/wp-content/uploads/2019/12/tech-innovation-min.jpg" alt="image not found">
                <p class="n_president_statement_link">Tech & Innovation</p></a>
         </div>
      </div>
