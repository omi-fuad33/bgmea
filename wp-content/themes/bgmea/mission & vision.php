<?php
   /*
       Template Name: Template Name: Mission and Vission
    */
   ?>
...
<!--                <p class="n_president_statement_link">Apparel Story</p>-->
         ...
         <div class="n_dailyBox n_president_box_wrap">
            <a href="<?php echo get_home_url(); ?>/bd-rmg-sector-at-a-glance/"><img class="n_media_section_president_img n_media_section_our_team_img" src="<?php echo get_home_url(); ?>/wp-content/uploads/2019/12/bd-rmg-minimum.jpg" alt="image not found">
           
                <p class="n_president_statement_link">BD RMG Sector</p></a>
         </div>
         
         <div class="n_dailyBox n_president_box_wrap">
            <a href="<?php echo get_home_url(); ?>/investment-trade/trade-information/"><img class="n_media_section_president_img n_media_section_our_team_img" src="<?php echo get_home_url(); ?>/wp-content/uploads/2019/12/trade-info-min.jpg" alt="image not found">
                <p class="n_president_statement_link">Trade Information</p></a>
         </div>
      </div>
